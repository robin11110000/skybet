...
import { Box, Button, Center, Container, Grid, GridItem, Heading, SimpleGrid } from "@chakra-ui/react";
...
const casino = () => {
    ...
    const onPlayGame = async () => {
        ...
        const playGame_Output = (await playGame(tableListFull[0], bets[0])).toString();
